<div class="page-header">
    <h1 class='white'>Diagnosis</h1>
</div>
<form action="?m=hasiluser" method="post">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-footer">
            <button class="btn btn-primary"><span class="glyphicon glyphicon-search"></span> Mulai Diagnosis</button>
        </div>
    </div>
</form>
<script>
